...
import logo from "../assets/ripplechat.png"
...
export default function LandingPage() {
  ...
  <div className="landing-brand">
    <img src={logo} alt="RippleChat" className="landing-logo" />
    ...
    >
      ...
      <section className="hero-section">
        <div className="hero-content">
          <span className="hero-badge">RippleChat messaging app </span>
          <h1 className="hero-title">Connect Instantly, Chat Securely</h1>
          <p className="hero-description">
            RippleChat brings secure, fast, and reliable messaging to everyone. 
